...
globalThis.fetch = async function (...args) {
    ...
    if (url.includes('/v1/users/') && url.includes('/subscription')) {
        try {
            ...
            logToTerminal("Original Subscription Response:", data);
            ...
            logToTerminal("Modified Subscription Response:", data);
            ...
            logToTerminal("Error modifying fetch response:", e.message);
        }
    }
    ...
    if (url.includes('/v1/videos/') && url.includes('/playbackinfo')) {
        try {
            ...
            logToTerminal("VideoPlaybackInfo intercept:", id);
            ...
            logToTerminal("VideoPlaybackInfo intercept error:", e.message);
        }
    }
        ...
        try {
            ...
            if (text.startsWith('{')) {
                try {
                    ...
                    logToTerminal("Original Playback Info:", data);
                    ...
                    logToTerminal("Modified Playback Info:", data);
            ...
            logToTerminal("Error modifying playback:", e.message);
        }
    }
    ...
    if (url.includes('/v2/trackManifests/')) {
        try {
            ...
            logToTerminal("TrackManifest intercept:", id, "Quality:", quality);
            ...
            logToTerminal("TrackManifest intercept error:", e.message);
        }
    }
...
globalThis.XMLHttpRequest.prototype.open = function (method, url, ...rest) {
    ...
    if (this._requestUrl.includes('api.tidal.com') || this._requestUrl.includes('/v1/') || this._requestUrl.includes('/v2/')) {
        logToTerminal("[XHR URL]:", this._requestUrl.split('?')[0]);
    }
